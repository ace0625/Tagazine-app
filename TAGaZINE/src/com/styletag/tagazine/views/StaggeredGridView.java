        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    ...
                    Mylog.v("onInterceptTouchEvent could not find pointer with id " +
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                final int index = MotionEventCompat.findPointerIndex(ev, mActivePointerId);
                if (index < 0) {
//                    Mylog("onInterceptTouchEvent could not find pointer with id " +
//                            mActivePointerId + " - did StaggeredGridView receive an inconsistent " +
//                            "event stream?");
                    return false;
                }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(int height) {
            ...
            if (this.height == MATCH_PARENT) {
                Mylog.v("Constructing LayoutParams with height FILL_PARENT - " +
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            if (this.width != MATCH_PARENT) {
                Mylog.v("Inflation setting LayoutParams width to " + this.width +
                        " - must be MATCH_PARENT");
                this.width = MATCH_PARENT;
            }
            if (this.height == MATCH_PARENT) {
                Mylog.v("Inflation setting LayoutParams height to MATCH_PARENT - " +
                        "impossible! Falling back to WRAP_CONTENT");
                this.height = WRAP_CONTENT;
            }
        ...
        public LayoutParams(ViewGroup.LayoutParams other) {
            ...
            if (this.width != MATCH_PARENT) {
                Mylog.v("Constructing LayoutParams with width " + this.width +
                        " - must be MATCH_PARENT");
                this.width = MATCH_PARENT;
            }
            if (this.height == MATCH_PARENT) {
                Mylog.v("Constructing LayoutParams with height MATCH_PARENT - " +
                        "impossible! Falling back to WRAP_CONTENT");
                this.height = WRAP_CONTENT;
            }
        }
